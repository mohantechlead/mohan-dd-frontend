...
export default function DemoPage() {
  ...
  const { data, error, isLoading } = useSWR<Customer[]>(CUSTOMER_API_URL, fetcher);
  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <Button onClick={() => router.push('/diredawa/partners/customers/create')}>Create Customers</Button>
      </div>
